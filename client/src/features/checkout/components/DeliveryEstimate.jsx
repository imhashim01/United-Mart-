import { Truck, Clock, ShieldCheck, CalendarDays } from "lucide-react";
import { useCartStore, DELIVERY_FLAT_RATE, FREE_DELIVERY_THRESHOLD } from "../../../store/cartStore";
...
export default function DeliveryEstimate() {
  ...
  const deliveryCharge = subtotal === 0 ? 0 : subtotal >= FREE_DELIVERY_THRESHOLD ? 0 : DELIVERY_FLAT_RATE;
        ...
        <div className="mt-4">
          <div className="h-2 rounded-full bg-linen-50 overflow-hidden mb-2">
            <div
              ...
              style={{ width: `${Math.min(100, ((FREE_DELIVERY_THRESHOLD - freeDeliveryProgress.remaining) / FREE_DELIVERY_THRESHOLD) * 100)}%` }}
            />
          </div>
