      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 py-8">
        ...
        {category ? (
          ...
          <div className="rounded-[var(--radius-lg)] border border-border bg-white p-8 text-center">
            ...
            <Link
              to="/"
              className="inline-flex items-center justify-center rounded-[var(--radius-md)] bg-orchard-900 px-4 py-2 text-sm font-semibold text-white hover:bg-orchard-700"
            >
              Back to Home
            </Link>
          </div>
